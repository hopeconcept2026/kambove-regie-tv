        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="hidden md:flex items-center gap-4 text-[11px] text-slate-400 py-1 font-mono">
            <div className="flex items-center gap-1.5" title="Montage NAS /mnt/regie_videos">
              <span className={`w-2 h-2 rounded-full ${status.nasStatus.mounted ? 'bg-emerald-400' : 'bg-rose-500'}`}></span>
              <span>NAS: {status.nasStatus.freeSpaceGB} Go libres</span>
            </div>
            ...
            <div className="flex items-center gap-1.5" title="Port Telnet Liquidsoap 1234">
              ...
              <span>Telnet 1234: OK</span>
            </div>

            <div className="flex items-center gap-1.5" title="Débit flux RTMP vers Owncast">
              <Radio className="w-3 h-3 text-indigo-400" />
              <span>RTMP: {status.rtmpStatus.bitrateKbps} kbps</span>
            </div>

            <div className="flex items-center gap-1.5" title="Charge CPU Ubuntu">
              <Cpu className="w-3 h-3 text-slate-400" />
              <span>CPU: {status.serverStatus.cpuPercent}%</span>
            </div>
          </div>
        </div>
      </div>
